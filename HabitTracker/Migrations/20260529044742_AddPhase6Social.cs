...
{
    /// <inheritdoc />
    public partial class AddPhase6Social : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageLikes", x => new { x.MessageId, x.LikerUserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_MessageLikes_Users_LikerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageLikes_LikerUserId",
                table: "MessageLikes",
                column: "LikerUserId");
