...
namespace HabitTracker.Migrations
{
    ...
    public partial class moi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Quests",
                columns: new[] { "Id", "Category", "CreatedAt", "Description", "Difficulty", "Frequency", "Icon", "IsActive", "Name", "UpdatedAt", "XPReward" },
                values: new object[,]
                {
                    { 1, "Sức khỏe", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Easy", "Daily", "💧", true, "Uống 2 lít nước", null, 10 },
                    { 2, "Sức khỏe", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Medium", "Daily", "🏃", true, "Tập thể dục 30 phút", null, 25 },
                    { 3, "Sức khỏe", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Easy", "Daily", "😴", true, "Ngủ đủ 8 tiếng", null, 10 },
                    { 4, "Sức khỏe", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Hard", "Weekly", "🏅", true, "Chạy bộ 5km", null, 50 },
                    { 5, "Học tập", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Easy", "Daily", "📚", true, "Đọc sách 20 phút", null, 10 },
                    { 6, "Học tập", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Medium", "Daily", "🗣️", true, "Học ngoại ngữ 30 phút", null, 25 },
                    { 7, "Học tập", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Hard", "Monthly", "🎓", true, "Hoàn thành 1 khóa học online", null, 50 },
                    { 8, "Tinh thần", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Easy", "Daily", "🧘", true, "Thiền 10 phút", null, 10 },
                    { 9, "Tinh thần", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Easy", "Daily", "📝", true, "Viết nhật ký", null, 10 },
                    { 10, "Tài chính", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Easy", "Daily", "💰", true, "Ghi chép chi tiêu hôm nay", null, 10 },
                    { 11, "Tài chính", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Medium", "Weekly", "🏦", true, "Tiết kiệm theo kế hoạch tuần", null, 25 }
                });
